	...
	$(document).ready(function(){
		...
		<div class="container content height-500">
			<div class="col-md-12 md-margin-bottom-40">
				...
				<div>
					<form class="sky-form" style="width: 1000px;">
						<h5><i class="fa fa-check-circle-o"></i> <b>SyncBook 회원 이용약관</b></h5>
						<label class="textarea">
							<textarea rows="10" disabled="disabled">
								㈜와이비엠시사닷컴 및 ㈜와이비엠시사 계열사는 관련 홈페이지의 공동 회원제를 실시하고 있습니다. 
㈜와이비엠시사닷컴 및 ㈜와이비엠시사 계열사 관련 홈페이지의 회원가입을 하시면 한번의 가입으로, 서비스하는 홈페이지들을 하나의 아이디와 비밀번호로 이용하실 수 있습니다.
제 1 조 (목적)
이 약관은 ㈜와이비엠시사닷컴 및 YBM Family사이트(이하 "회사")가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 제반 서비스를 의미합니다.
"회원"이라 함은 회사의 "서비스"에 접속하여 이 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객을 말합니다.
"아이디(ID)"라 함은 "회원"의 식별과 "서비스" 이용을 위하여 "회원"이 정하고 "회사"가 승인하는 문자와 숫자의 조합을 의미합니다.
"비밀번호"라 함은 "회원"이 부여 받은 "아이디와 일치되는 "회원"임을 확인하고 비밀보호를 위해 "회원" 자신이 정한 문자 또는 숫자의 조합을 의미합니다.
"유료서비스"라 함은 "회사"가 유료로 제공하는 각종 온라인디지털콘텐츠(각종 정보콘텐츠, VOD, 동영상강의, MP3파일, E-BOOK 및 기타 유료콘텐츠를 포함) 및 제반 서비스를 의미합니다.
"포인트"라 함은 서비스의 효율적 이용을 위해 회사가 임의로 책정 또는 지급, 조정할 수 있는 재산적 가치가 없는 "서비스" 상의 가상 데이터를 의미합니다.
"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.
제 3 조 (약관의 게시와 개정)
"회사"는 이 약관의 내용을 "회원"이 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다.
"회사"는 "약관의규제에관한법률", "정보통신망이용촉진 및 정보보호등에관한법률(이하 "정보통신망법")" 등 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
...
제 6 조 (회원정보의 변경)
"회원"은 개인정보관리화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만, 서비스 관리를 위해 필요한 실명, 생년월일, 아이디 등은 수정이 불가능합니다.
...
제 9 조 ("회원"에 대한 통지)
"회사"가 "회원"에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 서비스 내 전자우편 등을 활용 할 수 있습니다.
...
"회사"는 "회원"이 계속해서 3년 이상 로그인하지 않는 경우, 회원정보의 보호 및 운영의 효율성을 위해 이용을 제한할 수 있습니다.
제 21 조 (책임제한)
...
부칙
이 약관은 2012년 8월 31일부터 적용됩니다.
종전의 약관은 본 약관으로 대체합니다.
        					</textarea>
						</label>
						<label class="checkbox" style="margin-left: 10px">
							<input type="checkbox" id="checkbox1"><i></i> SyncBook 회원 이용약관에 동의합니다.
						</label>
						<hr/>
						<h5><i class="fa fa-check-circle-o"></i><b>개인정보 수집 및 이용안내</b></h5>
						<label class="textarea">
							<textarea rows="9">
								개인 정보 수집 항목
...
IP Address, 쿠키, 방문 일시, 서비스 이용 기록
						...
						<label class="checkbox" style="margin-left: 10px">
							<input type="checkbox" id="checkbox2"><i></i> 개인정보 수집 및 이용안내에 동의합니다.
						</label>
					</form>
				</div>
				<div align="center">
					<c:choose>
						<c:when test="${member != null}">
							<input type="button" id="okBtn" onclick="location.href='memberJoinForm'" value="확인" class="btn-u" disabled="disabled">
						</c:when>
						<c:when test="${teacher != null}">
							<input type="button" id="okBtn" onclick="location.href='teacherJoinForm'" value="확인" class="btn-u" disabled="disabled">
						</c:when>
					</c:choose>
					<input type="button" onclick="location.href='joinOption'" value="취소" class="btn-u">
				</div>
			</div>
		</div>
		<!--=== End Content ===-->
