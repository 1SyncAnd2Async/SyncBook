											...
											<!-- Page 이전 페이지 구현  --><c:choose>
												<c:when test="${sessionScope.member != null}">
													<c:choose>
														...
														<c:otherwise>
															 <ul class="pagination">
                        										<li><a href="sendMessageList?page= ${(pageInfo.currentBlock-1)*pageInfo.pagesPerBlock }&sender=${sessionScope.member.id}">
																«
															</a></li></ul>
														</c:otherwise>
													</c:choose>
													...
													<c:choose>
														...
														<c:otherwise>
															<ul class="pagination">
                        										<li><a
																href="sendMessageList?page=
                  ${pageInfo.currentBlock * pageInfo.pagesPerBlock + 1 }&sender=${sessionScope.member.id}">
																»
															</a></li>
															</ul>
														</c:otherwise>
												...
												<c:when test="${sessionScope.teacher != null}">
													<c:choose>
														...
														<c:otherwise>
															 <ul class="pagination">
                        										<li><a href="sendMessageList?page= ${(pageInfo.currentBlock-1)*pageInfo.pagesPerBlock }&sender=${sessionScope.teacher.id}">
																«
															</a></li></ul>
														</c:otherwise>
													</c:choose>
													...
													<c:choose>
														...
														<c:otherwise>
															<ul class="pagination">
                        										<li><a
																href="sendMessageList?page=
                  ${pageInfo.currentBlock * pageInfo.pagesPerBlock + 1 }&sender=${sessionScope.teacher.id}">
																»
															</a></li>
															</ul>
														</c:otherwise>
